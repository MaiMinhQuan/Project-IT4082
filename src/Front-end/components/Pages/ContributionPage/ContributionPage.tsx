...
function ContributionPage() {
  ...
  const fetchRequiredFee = async () => {
    try {
      const requiredFee: Fee[] = await window.electronAPI.fetchContributeFee();
  ...
  const handleSubmitDeleting = async (e: React.FormEvent) => {
    ...
    if (!check) {
      ...
      setConfirmationDeleteMessage(`Bạn có chắc chắn xoá khoản đóng góp của phòng ${searchDeletedRoom}?`);
  ...
  const handleConfirmDeleting = async () => {
    ...
    try {
      const success = await window.electronAPI.deleteContributeFee(Number(searchDeletedRoom));
      if (success) {
        setSuccessDeleteModalOpen(true); // Show success modal
      } else {
        setErrorDeleteMessage("Thêm khoản đóng góp không thành công.");
  ...
  const handleSubmitAdding = async (e: any) => {
    ...
    if (!check) {
      ...
      setConfirmationAddMessage(`Bạn có chắc chắn thêm khoản đóng góp của phòng ${submitRoomNumber}?`)
  ...
  const handleConfirmAdding = async () => {
    ...
    try {
      const success = await window.electronAPI.addContributeFee(Number(submitRoomNumber), money, submitTransferrer);

      if (success) {
        setSuccessAddModalOpen(true);
      } else {
        setErrorAddMessage("Thêm khoản đóng góp không thành công.");
        setErrorAddModalOpen(true);
      }
    } catch(error) {
      console.log(error);
  ...
  const handleSubmitEditing = async (e: any) => {
    ...
    if (!check) {
      ...
      setConfirmationEditMessage(`Bạn có chắc chắn chỉnh sửa khoản đóng góp của phòng ${searchEditedRoom}?`)
  ...
  const handleConfirmEditing = async () => {
    ...
    try {
      ...
      const success = await window.electronAPI.editContributeFee(Number(searchEditedRoom), Number(money), transferrer);

      if (success) {
        setSuccessEditModalOpen(true);
      } else {
        setErrorEditMessage("Chỉnh sửa khoản đóng góp không thành công.");
        setErrorEditModalOpen(true);
      }
    } catch(error) {
      console.log(error);
          ...
          <Content style={{ margin: '14px', background: '#fff' }}>
            <div className="min-h-screen bg-gray-100 p-6">
              <div className="container mx-auto grid grid-cols-2 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <form onSubmit={handleSubmitAdding}>
                    ...
                    <ConfirmModal
                      ...
                      title="Xác nhận thêm khoản đóng góp"
                    ...
                    <ConfirmModal
                      ...
                      title="Thành công"
                      bodyText="Đã thêm khoản đóng góp thành công."
                      confirmText=""
                      cancelText="Huỷ"
                    />
                  </form>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h2 className="text-2xl font-semibold mb-4">Chỉnh sửa khoản đóng góp</h2>
                  <form onSubmit={handleSubmitEditing}>
                    ...
                    <ConfirmModal
                      ...
                      title="Xác nhận chỉnh sửa khoản đóng góp"
                    ...
                    <ConfirmModal
                      ...
                      title="Thành công"
                      bodyText="Đã chỉnh sửa khoản đóng góp thành công."
                      confirmText=""
                      cancelText="Huỷ"
                    />
                  </form>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h2 className="text-2xl font-semibold mb-4">Xoá khoản đóng góp</h2>
                  <form onSubmit={handleSubmitDeleting}>
                    ...
                    <ConfirmModal
                      ...
                      title="Xác nhận xoá khoản đóng góp"
                    ...
                    <ConfirmModal
                      ...
                      title="Thành công"
                      bodyText="Đã xoá khoản đóng góp thành công."
                      confirmText=""
                      cancelText="Huỷ"
                    />
              ...
              {/* <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-4"> */}
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h2 className="text-2xl font-semibold mb-4">Xem khoản đóng góp</h2>
                  <label
                        className="block text-sm font-medium mb-2"
                        htmlFor="roomNumber"
                      >
